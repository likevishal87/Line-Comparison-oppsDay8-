...
public class compareTwoline {
	...
	public static void main(String[] args) {
		...
		Double lenghtOfLine1 = Math.sqrt(Math.pow(x2 - x1, 2) + Math.pow(y2 - y1, 2)); // calculate the length of first
																						// line
		Double lengthOfLine2 = Math.sqrt(Math.pow(p2 - p1, 2) + Math.pow(q2 - q1, 2)); // calculate the length of second
																						// line

		System.out.printf("Length of First Line is : %.2f %n", lenghtOfLine1); // %.2f %n to print only two digit after
																				// point
		System.out.printf("length of Second Line : %.2f %n", lengthOfLine2); // %.2f %n to print only two digit after
																				// point
